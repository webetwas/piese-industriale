...
class Programul_nostru extends CI_Controller {
  ...
  public function index()
  {
      ...
      case UPDATE:
				if(isset($this->uriseg->id) && !is_null($this->uriseg->id)):		
					...
					if(isset($_REQUEST["{$form_submititem}"])) {
						...
						if($update) $this->_Session->setFB_Pozitive(array("ref" => "Programul nostru", "text" => "Modificarile tale au fost salvate!"));
    ...
    $view = (object) [ 'html' => array(
      ...
      1 => (object) ["viewhtml" => "programul_nostru/item", "viewdata" => $viewdata]
      ), 'javascript' => array(
      1 => (object) ["viewhtml" => "programul_nostru/js_item", "viewdata" => null],
      )
    ];
