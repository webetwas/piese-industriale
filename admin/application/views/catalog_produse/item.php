                        ...
                        <div class="file-manager">
							...
							<div class="row">
								...
								<label class="control-label" style="text-align:left;color:#1ab394;margin-top:-3px;">
									<span style="font-size:17px;font-weight:normal;"><sub><i class="fa fa-plug" style="color:#1ab394;;font-size:25px;"></i></sub>&nbsp;&nbsp;Afi&scedil;eaz&abreve; pe sit..&nbsp;</span> <i class="fa fa-angle-double-down" style="font-size:15px;"></i>
								</label>
								</div>
							</div>
