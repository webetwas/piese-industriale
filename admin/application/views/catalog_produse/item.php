...
<div class="wrapper wrapper-content animated fadeIn">
	...
	<div class="row">
	            ...
	            <div class="ibox-content mailbox-content">
	                <div class="file-manager">
						...
						<div class="row">
							...
							<label class="control-label" style="text-align:left;color:#1ab394;margin-top:-3px;">
								<span style="font-size:17px;font-weight:normal;"><sub><i class="fa fa-plug" style="color:#1ab394;;font-size:25px;"></i></sub>&nbsp;&nbsp;Afiseaza pe site&nbsp;</span> <i class="fa fa-angle-double-down" style="font-size:15px;"></i>
							</label>
							</div>
						</div>
						<div class="row" style="margin-left:-20px;margin-right:-20px;padding:7px;">
							<div class="form-group" style="margin:0;">
		...
		<?php endif; ?>
	    <div class="col-lg-<?=(!is_null($item) ? '12' : '12')?> animated fadeInRight">
